...
import { AuthAPI, BankAPI, DistributionAPI, GovAPI, MarketAPI, MintAPI, MsgAuthAPI, OracleAPI, SlashingAPI, StakingAPI, SupplyAPI, TendermintAPI, TreasuryAPI, TxAPI, WasmAPI } from './api';
